...
// the [NewClusterGroupsAndGPUClusterGroupService] method instead.
type ClusterGroupsAndGPUClusterGroupService struct {
	Options []option.RequestOption
}

// NewClusterGroupsAndGPUClusterGroupService generates a new service that applies
...
func NewClusterGroupsAndGPUClusterGroupService(opts ...option.RequestOption) (r *ClusterGroupsAndGPUClusterGroupService) {
	r = &ClusterGroupsAndGPUClusterGroupService{}
	r.Options = opts
	return
}
